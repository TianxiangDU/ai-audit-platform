      ...
      <div className="space-y-8 p-6">
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8">
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className="text-gray-600">利用人工智能技术，提升工程审计效率和准确性</p>
            </div>
            <Link
              to="/projects/new"
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200">
          <div className="px-8 py-6 border-b border-gray-200">
            ...
            <p className="text-gray-600 mt-1">选择操作快速开始您的审计工作</p>
          </div>
          <div className="p-8">
            <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
              {quickActions.map((action, index) => (
                <Link
                  key={index}
                  to={action.link}
                  className="group p-6 rounded-lg border border-gray-200 hover:border-gray-300 hover:shadow-md transition-all duration-300"
                >
                  <div className={`inline-flex p-3 ${action.iconBg} rounded-lg mb-4`}>
        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-2">
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200">
            <div className="px-8 py-6 border-b border-gray-200">
              <div className="flex justify-between items-center">
                <h3 className="text-xl font-bold text-gray-900">最近项目</h3>
                <Link
                  to="/projects"
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200">
            <div className="px-8 py-6 border-b border-gray-200">
              <h3 className="text-xl font-bold text-gray-900">待办任务</h3>
              <p className="text-gray-600 mt-1">需要您关注的重要任务</p>
            </div>
            <div className="divide-y divide-gray-100">
