...
import { ArrowLeft, Calendar, FileText, CheckCircle, AlertTriangle, Users, FolderOpen, Eye, Plus, Bot, List, Search, Target } from 'lucide-react';
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200">
          <div className="px-8 py-6 border-b border-gray-200">
            <div className="flex justify-between items-center">
              <div>
                <h3 className="text-xl font-bold text-gray-900">审计成果管理</h3>
                <p className="text-gray-600 mt-1">查看和管理项目的审计线索、问题、底稿和报告</p>
              </div>
              <Link
          ...
          <div className="p-8">
            <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
              <Link
                to={`/projects/${id}/results?tab=clues`}
                className="bg-gray-50 p-6 rounded-lg border border-gray-200 hover:shadow-md hover:border-blue-300 transition-all duration-300 cursor-pointer group"
              >
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-sm font-medium text-gray-600 mb-1">审计线索</p>
                    <p className="text-2xl font-bold text-gray-900 group-hover:text-blue-600">{auditResults.clues}</p>
              ...
              <Link
                to={`/projects/${id}/results?tab=issues`}
                className="bg-gray-50 p-6 rounded-lg border border-gray-200 hover:shadow-md hover:border-red-300 transition-all duration-300 cursor-pointer group"
              >
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-sm font-medium text-gray-600 mb-1">审计问题</p>
                    <p className="text-2xl font-bold text-gray-900 group-hover:text-red-600">{auditResults.issues}</p>
              ...
              <Link
                to={`/projects/${id}/results?tab=workpapers`}
                className="bg-gray-50 p-6 rounded-lg border border-gray-200 hover:shadow-md hover:border-blue-300 transition-all duration-300 cursor-pointer group"
              >
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-sm font-medium text-gray-600 mb-1">审计底稿</p>
                    <p className="text-2xl font-bold text-gray-900 group-hover:text-blue-600">{auditResults.workpapers}</p>
              ...
              <Link
                to={`/projects/${id}/results?tab=reports`}
                className="bg-gray-50 p-6 rounded-lg border border-gray-200 hover:shadow-md hover:border-green-300 transition-all duration-300 cursor-pointer group"
              >
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-sm font-medium text-gray-600 mb-1">审计报告</p>
                    <p className="text-2xl font-bold text-gray-900 group-hover:text-green-600">{auditResults.reports}</p>
